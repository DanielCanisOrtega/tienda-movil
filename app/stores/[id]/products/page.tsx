  ...
  return (
    <main className="flex min-h-screen flex-col bg-background-light android-safe-top">
      <div className="bg-white p-4 flex items-center">
        <Button variant="ghost" className="mr-4 p-2" onClick={goBackToHome} aria-label="Volver a inicio">
      ...
      <div className="p-4">
        <div className="flex items-center mb-4 gap-2">
          ...
          <Button variant="outline" className="bg-white flex items-center gap-2 px-3" onClick={startBarcodeScanner}>
        ...
        {error ? (
          ...
          <div className="bg-white rounded-lg p-6 text-center">
            ...
            {searchTerm ? (
              ...
              <Button onClick={navigateToAddProduct} className="bg-primary hover:bg-primary-dark">
                Añadir producto
              </Button>
            )}
          </div>
